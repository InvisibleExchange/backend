...
app.post("/execute_withdrawal", async (req, res) => {
  ...
  console.log("Gas Fee: ", executionGasFee);

  if (
    (executionGasFee > req.body.max_gas_fee || executionGasFee == 0) &&
    req.body.max_gas_fee != 0
  ) {
  ...
  req.body.execution_gas_fee = executionGasFee.toString();
