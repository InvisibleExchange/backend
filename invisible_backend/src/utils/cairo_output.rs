...
//     // & n_output_notes (32 bits) | n_output_positions (16 bits) | n_output_tabs (16 bits) | n_zero_indexes (32 bits) |
...
//     let res_vec = split_by_bytes(
//         output_counts1,
//         vec![32, 16, 16, 32, 16, 16, 16, 16, 16, 16, 16, 16],
//     );
...
//     let n_mm_registrations = res_vec[6].to_u16().unwrap();
//     let n_mm_add_liquidity = res_vec[7].to_u16().unwrap();
//     let n_mm_remove_liquidity = res_vec[8].to_u16().unwrap();
//     let n_note_escapes = res_vec[9].to_u16().unwrap();
//     let n_position_escapes = res_vec[10].to_u16().unwrap();
//     let n_tab_escapes = res_vec[11].to_u16().unwrap();
